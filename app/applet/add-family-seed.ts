...
const extraVocab = `
  ...
  },
  {
    ...
    partOfSpeech: 'phrase',
    definition: 'To clean plates, bowls, cups, etc. after a meal.',
    vietnameseTranslation: 'Rửa bát',
    exampleSentence: 'Can you wash the dishes after dinner?',
    exampleTranslation: 'Bạn có thể rửa bát sau bữa tối được không?',
    marketingContext: 'Từ vựng công việc nhà.',
  ...
  },
  {
    ...
    word: 'Groceries',
    partOfSpeech: 'noun',
    definition: 'Food and other goods sold at a supermarket.',
    vietnameseTranslation: 'Tạp hóa / Đồ đi chợ',
    exampleSentence: 'We need to buy groceries for the week.',
    exampleTranslation: 'Chúng ta cần mua đồ ăn cho cả tuần.',
    marketingContext: 'Từ vựng mua sắm gia đình.',
    category: 'Shopping',
...
const extraFormulas = `
  ...
  },
  {
    ...
    exampleVi: 'Bạn có thể đi đổ rác được không?',
  ...
  },
  {
    ...
    example: 'We need to buy milk and diapers.',
    exampleVi: 'Chúng ta cần mua sữa và tã.',
